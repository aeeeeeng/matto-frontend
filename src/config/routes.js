...
const Supplier = React.lazy(() => import('../components/contents/Master/Supplier/Supplier'));
...
const routes = [
    ...
    { link: '/master', name: 'master', label: 'Master', component: Master, isCollapse: false, icon: faDatabase, child:[
        ...
        { link: '/master/supplier', name: 'supplier', label: 'Supplier', component: Supplier, exact:'/example' }
    ]},
